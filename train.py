...
def parse_args():
    ...
    parser.add_argument('--data_cfg_path', type=str, default='configs/data/megadepth_trainval_640.py',
                        help='data config path')
    parser.add_argument('--main_cfg_path', type=str, default='configs/loftr/outdoor/loftr_ds_dense.py',
...
def main():
    ...
    # lightning module
    profiler = build_profiler(args.profiler_name)  # PassThroughProfiler
    model = PL_LoFTR(config, pretrained_ckpt=None, profiler=profiler)
