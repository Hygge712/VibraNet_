...
class LoFTRLoss(nn.Module):
    def __init__(self, config):
        ...
        self.match_type = self.config['loftr']['match_coarse']['match_type']  # dual_softmax
        self.sparse_spvs = self.config['loftr']['match_coarse']['sparse_spvs']  # True

        # coarse-level
        self.correct_thr = self.loss_config['fine_correct_thr']  # 1.0
        self.c_pos_w = self.loss_config['pos_weight']  # 1.0
        self.c_neg_w = self.loss_config['neg_weight']  # 1.0
        # fine-level
        self.fine_type = self.loss_config['fine_type']  # l2_with_std
