...
_CN = CN()
# _CN.BACKBONE_TYPE = 'ResNetFPN'  # options: ['ResNetFPN', 'DenseNet']
_CN.BACKBONE_TYPE = 'DenseNet'  # options: ['ResNetFPN', 'DenseNet']
...
_CN.RESNETFPN = CN()
_CN.RESNETFPN.INITIAL_DIM = 128  # 96 or 128
_CN.RESNETFPN.BLOCK_DIMS = [128, 196, 256]  # s1, s2, s3; [96, 128, 196, 256] Or [128, 196, 256]

_CN.DENSENET = CN()
_CN.DENSENET.INITIAL_DIM = 128
_CN.DENSENET.BLOCK_DIMS = [128, 192, 256]  # s1, s2, s3  # IE-LoFTR
# _CN.DENSENET.BLOCK_DIMS = [128, 196, 256]  # s1, s2, s3  # CD-LoFTR
_CN.DENSENET.GROWTH_RATE = 64  # if use cspDenseNet
_CN.DENSENET.NUM_BLOCKS = 1
_CN.DENSENET.NUM_LAYERS_PER_BLOCK = 3
