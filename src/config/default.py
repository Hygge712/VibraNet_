...
##############  ↓  LoFTR Pipeline  ↓  ##############
_CN.LOFTR = CN()
# _CN.LOFTR.BACKBONE_TYPE = 'ResNetFPN'  # choice [ResNetFPN, DenseNet]
_CN.LOFTR.BACKBONE_TYPE = 'DenseNet'  # choice [ResNetFPN, DenseNet]
...
_CN.LOFTR.DENSENET = CN()
_CN.LOFTR.DENSENET.INITIAL_DIM = 128
_CN.LOFTR.DENSENET.BLOCK_DIMS = [128, 192, 256]  # s1, s2, s3
_CN.LOFTR.DENSENET.GROWTH_RATE = 64  # if use cspDenseNet
_CN.LOFTR.DENSENET.NUM_BLOCKS = 1
_CN.LOFTR.DENSENET.NUM_LAYERS_PER_BLOCK =3
